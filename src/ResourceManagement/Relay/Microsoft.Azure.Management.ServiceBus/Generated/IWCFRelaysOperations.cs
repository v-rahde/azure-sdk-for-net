...
namespace Microsoft.Azure.Management.Relay
{
    ...
    public partial interface IWCFRelaysOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<AzureOperationResponse<IPage<HybridConnectionResource>>> GetWithHttpMessagesAsync(string resourceGroupName, string namespaceName, string relayName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
