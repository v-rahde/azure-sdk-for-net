...
namespace Microsoft.Azure.Management.Relay.Models
{
    ...
    public partial class NamespaceResource : Resource
    {
        ...
        public NamespaceResource(string location, string id = default(string), string name = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), NameSpaceResourceType? type = default(NameSpaceResourceType?), string path = default(string), Relaytype? relayType = default(Relaytype?), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? updatedAt = default(System.DateTime?), int? listenerCount = default(int?), bool? requiresClientAuthorization = default(bool?), AuthorizationRules authorizationRules = default(AuthorizationRules), bool? requiresTransportSecurity = default(bool?), bool? isDynamic = default(bool?), string userMetadata = default(string), string collectionName = default(string))
